...
//    val name = "Hi, " +"John Doe"
    ...
    fun Rent(context:Context){
        ...
        LaunchedEffect(uid) {
            if (uid != null) {
                FirebaseFirestore.getInstance().collection("users").document(uid).collection("rent").get().
                    ...
                    if (task.isSuccessful){
                        ...
                        result?.let { querySnapshot ->
                            ...
                            for (document in querySnapshot) {
                                ...
                                val wearableModel =
                                    Wearables(name, price.toInt(), imageUrl, description,lat.toDouble(),long.toDouble())
